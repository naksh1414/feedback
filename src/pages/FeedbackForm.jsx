...
import back from "../../src/assets/feedback/animation_ln8xb45q.json";
...
export default function FeedbackForm() {
  ...
  const handleNameChange = (event) => {
    ...
    const namePattern = /^[A-Za-z]+$/; // Allow only letters
    if (!newName) {
      ...
      <form onSubmit={handleSubmit} className="main-feedback-section">
        <div className="feedback-form-left">
          <div className="para">
            ...
            <Lottie animationData={back} loop={true} className="svg-animation-mobile" />
          </div>
          <div className="type">
